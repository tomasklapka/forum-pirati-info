...
class ScrapingQueue {
    ...
    stats() {
        ...
        Promise.all(promises).then((results) => {
            ...
            statsOut('forums seq: %s', JSON.stringify(this.sequences.forums.asJson(), 0));
            statsOut('groups seq: %s', JSON.stringify(this.sequences.groups.asJson(), 0));
            statsOut(' users seq: %s', JSON.stringify(this.sequences.users.asJson(), 0));
            statsOut(' posts seq: %s', JSON.stringify(this.sequences.posts.asJson(), 0));
